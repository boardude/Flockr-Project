...
def test_invite_invalid_channel():
    '''
    #10.14 change the function name from "test_invite_InputError_invalid_channel"
    #to "test_invite_invalid_channel"
...
def test_invite_invalid_u_id():
    '''
    #10.14 change the function name from "test_invite_InputError_invalid_u_id"
    #to "test_invite_invalid_u_id"
...
def test_invite_not_authorised_member():
    '''
    #10.14 change the function name from "test_invite_AccessError_not_authorised_member" to
    #"test_invite_not_authorised_member"

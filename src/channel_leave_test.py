...
def test_channel_leave():
    ...
    token_2 = auth.auth_login('12345@gmail.com', '123#234')['token']
    channel_id = channels_create(token_1 ,'test_channel', True)['c_id']

...
# 9th edition 11/12/2020 daoting and Aidan
#   add new attributes 'reacts'(list) and 'is_pinned'(boolean) for massage.
#   reacts is a list of dicts containing types { react_id, u_ids, is_this_user_reacted }
#   react_id is the id of a react, and u_ids is a list of user id's of
#   people who've reacted for that react. is_this_user_reacted is whether or not
#   the authorised user has been one of the reacts to this post.

# 10th edition 11/13/2020 daoting
#   add new attributes 'profile_img_url'(string) for user
#   it is for storing the path of user's profile photo
